                        ...
                        if (player != null && player.isPl()) {
                            ...
                            if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
                                NpcService.gI().createTutorial(player, -1,
                                        "Chào Mừng " + player.name + " Đến Với: " + DragonRun.NAME + "\n"
                            ...
                            player.sendNewPet();
//                            if (player.isAdmin()) {
//                                Service.gI().sendMessageServer("Admin Login !!!!!");
//                            }
    ...
    public void login2(MySession session, Message msg) {
        Service.gI().sendThongBaoOK(session, "Đăng Ký Tài Khoản Tại: " + DragonRun.LINK + "");
    }
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player, "|0| Chào mừng bạn đến với " + DragonRun.NAME + "\n");
    }
}
