...
import services.SummonDragonNamek;
import utils.Util;
...
public class Client implements Runnable {
    ...
    private Client() {
        Thread.ofPlatform().name("Update Client").start(this);
    }
    ...
    private void remove(MySession session) {
        ...
        DragonRun.gI().disconnect(session);
    }
    ...
    public void close() {
        Logger.log(Logger.GREEN, "{/} - Session Close...." + players.size() + "\n");
        ...
        Logger.success("{/} - Author: NgojcDev\n");
    }
