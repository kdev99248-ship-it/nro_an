...
import boss.list.TauPayPay_DHVT;
import boss.list.PonPut;
import boss.list.Pocolo_dhvt;
import boss.list.LiuLiu;
import boss.list.ODo;
import boss.list.JackyChun;
import boss.list.ChaPa;
import boss.list.ThienXinHang;
import boss.list.Yamcha;
import boss.list.SoiHecQuyn_DHVT;
import boss.list.ChanXu;
import boss.list.Xinbato;
...
public class The23rdMartialArtCongress {
    ...
    public void toTheNextRound() {
        try {
            ...
            switch (round) {
                case 0:
                    bss = new SoiHecQuyn_DHVT(player);
                    break;
                case 1:
                    bss = new ODo(player);
                    break;
