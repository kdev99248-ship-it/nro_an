            ...
            if (CombineSystem.isCoupleItemNangCapCheck(itemDo, itemDNC)) {
                ...
                if (level < MAX_LEVEL_ITEM) {
                    ...
                    if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                        if(option != null){
                              option.param += Math.max((option.param * 10 / 100), 1);
                        }
                        if(option2 != null){
                             option2.param += Math.max((option2.param * 10 / 100), 1);
                        }
                        if (optionLevel == null) {
                        ...
                        if ((level == 2 || level == 4 || level == 6) && (player.combineNew.itemsCombine.size() != 3)) {
                            if(option!= null){
                                option.param -= Math.max((option.param * 11 / 100), 1);
                            }
                            if(option2!=null){
                                option2.param -= Math.max((option2.param * 11 / 100), 1);
                            }
                            optionLevel.param--;
                        }
