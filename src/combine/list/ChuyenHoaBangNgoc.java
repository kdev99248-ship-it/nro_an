...
public class ChuyenHoaBangNgoc {
    ...
    public static void showInfoCombine(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            ...
            int ngocChuyenHoa = 400;
            if (levelTrangBi == 3) {
                ngocChuyenHoa = 400;
            } else if (levelTrangBi == 4) {
                ngocChuyenHoa = (int)(400 * 1.5);
            } else if (levelTrangBi == 5) {
                ngocChuyenHoa = (int)(400 * 2.0);
            } else if (levelTrangBi == 6) {
                ngocChuyenHoa = (int)(400 * 2.5);
            } else if (levelTrangBi >= 7) {
                ngocChuyenHoa = (int)(400 * 3.0);
            }
            ...
            if (khongthechuyenhoa == 1) {
                ...
                NpcSay += "|2|Cần" + ngocChuyenHoa + " ngọc";
