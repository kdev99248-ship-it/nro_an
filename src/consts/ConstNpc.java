...
public class ConstNpc {
    ...
    public static final byte NGOJCDEV = 88;
    public static final byte TORIBOT_TS = 74;
    public static final byte TORIBOT_BVIP = 75;
    ...
    public static final int MENU_TOPUP_REWARD = 503;
    ...
    public static final int CONFIRM_REMOVE_ALL_ITEM_MAIL = 518;
    public static final int MENU_SEND_MAIL_TO_PLAYER = 519;
    public static final int MENU_SEND_MAIL_MULTI_OPTION = 520;
    ...
    public static final int MENU_HOP_QUA_THAN_LINH = 2008;
    ...
    public static final int MENU_THOI_VANG = 503;
    public static final int MENU_QUY_DOI_THOI_VANG = 504;
    public static final int MENU_RUT_THOI_VANG = 505;
    public static final int MENU_MO_THANH_VIEN = 506;
    public static final int MENU_HOM_THU = 507;
    ...
    public static final int MENU_HALLOWEEN = -9217321;
    public static final int MENU_CHON_SL_KEO = -219372;
    public static final int MENU_DOI_THIEP = -877632;
