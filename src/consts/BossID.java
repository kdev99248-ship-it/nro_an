...
public class BossID {
    ...
    public static final int CHILLER_1 = -12321;
    public static final int CHILLER_2 = -19283;
        public static final int SUPER_PIC = -1283;
            public static final int BLACK_GOKU_ROSE = -283;
    ...
    public static final int CUMBER = -614;
    ...
    // ========================KID BUU========================
    public static final int KID_BUU = -674;
     public static final int KID_XEN = -675;
    public static final int BOSS_XUONG = -9128;
}
