...
public class CADICH extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        // Rơi thẻ thay skill khi cấp độ 110 với tỷ lệ 100%
        if (this.clan != null && this.clan.ConDuongRanDoc != null && this.clan.ConDuongRanDoc.level == 110) {
            // Random 1 trong 4 thẻ thay skill (1774-1777)
            int skillCardId = 1774 + Util.nextInt(0, 3); // Random từ 1774 đến 1777
            ItemMap skillCard = new ItemMap(this.zone, skillCardId, 1, this.location.x, 
                    this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, skillCard);
        }
    }
