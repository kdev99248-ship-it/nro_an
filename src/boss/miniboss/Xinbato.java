...
public class Xinbato extends Boss {
    ...
    private boolean Ngojc_Check = false;
    private long Ngojc_1 = 0;
    ...
    public void NhatXuong1() {
        Ngojc_Check = true;
        Ngojc_1 = System.currentTimeMillis();

    }

    public boolean Ngojc_Check() {
        return Ngojc_Check;
    }
    ...
    public void attack() {
        if (Util.canDoWithTime(this.lastTimeAttack, 100)) {
            ...
            try {
                ...
                if (Ngojc_1 > 0) {
                    if (Util.canDoWithTime(Ngojc_1, 5000)) {
                        Ngojc_1 = 0;
                        Ngojc_Check = false;
                    }
                }
