...
public class SoiHecQuyn extends Boss {
    ...
    private boolean Ngojc_KiemTraNhatXuong = false;
    private long Ngojc_ThoiGianNhatXuong = 0;
    ...
    public void joinMap() {
        if (zoneFinal != null) {
            ...
            this.Ngojc_ThoiGianNhatXuong = 0;
            this.Ngojc_KiemTraNhatXuong = false;
            return;
        }
    ...
    public void NhatXuong() {
        Ngojc_KiemTraNhatXuong = true;
        Ngojc_ThoiGianNhatXuong = System.currentTimeMillis();

    }

    public boolean Ngojc_KiemTraNhatXuong() {
        return Ngojc_KiemTraNhatXuong;
    }
    ...
    public void attack() {
        if (Util.canDoWithTime(this.lastTimeAttack, 100)) {
            ...
            try {
                ...
                if (Ngojc_ThoiGianNhatXuong > 0) {
                    if (Util.canDoWithTime(Ngojc_ThoiGianNhatXuong, 5000)) {
                        Ngojc_ThoiGianNhatXuong = 0;
                        Ngojc_KiemTraNhatXuong = false;
                    }
                }
            } catch (Exception ex) {
            }
