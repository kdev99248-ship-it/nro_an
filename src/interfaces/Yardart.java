...
public abstract class Yardart extends Boss {
    ...
    public Yardart(BossType NgocRongMeow, int id, BossData... data) throws Exception {
        super(NgocRongMeow, id, data);
    }
        ...
        if (Util.canDoWithTime(this.lastTimeAttack, 100) && this.typePk == ConstPlayer.PK_ALL) {
            ...
            try {
                ...
                if (pl != null && !pl.isDie()
                    ...
                    this.nPoint.dame = (pl.nPoint.hpMax * Util.nextInt(1, 3) / 100)
                            / (Util.nextInt(10, 30));
