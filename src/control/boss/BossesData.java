...
public class BossesData {
    ...
    private static final int REST_25_M = 25 * 60;
    ...
    // Boss Android
    public static final BossData CHILLER_1 = new BossData(
            "Chiller 1", // name
            ConstPlayer.TRAI_DAT, // gender
            ...
            new String[]{"|-2|Chào anh! em đứng đây từ chiều",}, // text chat 1
            new String[]{"|-1|Oải rồi hả?",
                    "|-1|Ê cố lên nhóc",
                    "|-1|Chán"}, // text chat 2
            new String[]{}, // text chat 3
    ...
    public static final BossData CHILLER_2 = new BossData(
            ...
            new String[]{"|-2|Chào em! Admin An đứng đây từ chiều",}, // text chat 1
            new String[]{"|-1|Oải rồi hả?",
                    "|-1|Ê cố lên nhóc",
                    "|-1|Chán"}, // text chat 2
            new String[]{}, // text chat 3
    ...
    public static final BossData SUPER_PIC = new BossData(
            "SUPER PIC", // name
            ConstPlayer.TRAI_DAT, // gender
    ...
    public static final BossData BL_GOKU_ROSE = new BossData(
            "Black Goku Rose", // name
            ConstPlayer.TRAI_DAT, // gender
            new short[]{1624, 1628, 1629, -1, -1, -1}, // outfit {head, body, leg, bag, aura, eff}
            200_000, // dame
            ...
            new String[]{"|-2|Chào em! Admin An Goku đứng đây từ chiều",}, // text chat 1
            new String[]{"|-1|Oải rồi hả?",
                    "|-1|Ê cố lên nhóc",
                    "|-1|Chán"}, // text chat 2
            new String[]{}, // text chat 3
    ...
    public static final BossData BOSS_XUONG = new BossData(
            "Boss Xương", // name
            ConstPlayer.XAYDA, // gender
            new short[]{546, 548, 549, -1, 1, -1}, // outfit {head, body, leg, bag, aura, eff}
            1000, // dame
            new int[]{50_000}, // hp
    ...
    public static final BossData LAN_CON = new BossData(
            ...
            new String[]{"|-1|Ngọc Rồng Hip"}, // text chat 3
            REST_1_M // type appear
    );

    public static final BossData KID_BUU = new BossData(
            "Kid Bư", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1482, 1483, 1484, -1, 16, -1}, // outfit {head, body, leg, bag, aura, eff}
            50000000, // dame
            new int[]{2000000000}, // hp - 2 tỷ HP
            new int[]{52}, // map join - Kaio
            new int[][]{
                    {Skill.KAMEJOKO, 7, 1000},
                    {Skill.MASENKO, 7, 1000},
                    {Skill.ANTOMIC, 7, 1000},
            ...
            new String[]{
                    "|-1|Tại sao... tại sao lại như thế này...",
                    "|-1|Buu không tha cho ngươi đâu!",
                    "|-1|Hãy chuẩn bị đi!"
            }, // text chat 1 (đã thêm đủ 3 câu để không lỗi)
            new String[]{
                    "|-1|Majin Buu sẽ tiêu diệt tất cả!",
                    "|-1|Buu không cần lý do để giết!",
                    "|-1|Buu thích phá hoại!",
                    "|-1|Hahaha! Buu rất mạnh!",
                    "|-1|Các ngươi sẽ biến thành kẹo!",
                    "|-1|Buu sẽ hủy diệt vũ trụ!"
            }, // text chat 2
            new String[]{
                    "|-1|Buu... sẽ... quay lại...",
                    "|-1|Không thể nào... Buu bất tử mà..."
            }, // text chat 3
            REST_15_M // second rest
    );
    public static final BossData KID_XEN = new BossData(
            "Kid Xên", // name
            ConstPlayer.XAYDA, // gender
            new short[]{1479, 1480, 1481, -1, 16, -1}, // outfit {head, body, leg, bag, aura, eff}
            1_000_000, // dame
            new int[]{2_000_000_000}, // hp - 2 tỷ HP
            new int[]{169, 170, 171}, // map join - Kaio
            new int[][]{
                    {Skill.KAMEJOKO, 7, 1000},
                    {Skill.MASENKO, 7, 1000},
                    {Skill.ANTOMIC, 7, 1000},
            ...
            new String[]{
                    "|-1|Tại sao... tại sao lại như thế này...",
                    "|-1|Xên không tha cho ngươi đâu!",
                    "|-1|Hãy chuẩn bị đi!"
            }, // text chat 1 (đã thêm đủ 3 câu để không lỗi)
            new String[]{
                    "|-1|Xên sẽ tiêu diệt tất cả!",
                    "|-1|Xên không cần lý do để giết!",
                    "|-1|Xên thích phá hoại!",
                    "|-1|Hahaha! Xên rất mạnh!",}, // text chat 2
            new String[]{
                    "|-1|Xên... sẽ... quay lại...",
                    "|-1|Không thể nào... Xên bất tử mà..."
            }, // text chat 3
            REST_15_M // second rest
    );
}
