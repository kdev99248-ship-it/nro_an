...
import boss.list.SAIBAMEN;
import boss.list.NADIC;
import boss.list.CADICH;
        ...
        for (Zone zone : this.zones) {
            ...
            if (zone.map.mapId == 144) {
                try {
                    ...
                    int bossMaxHealth = (2000000 * level);
                    for (int i = 6; i > 0; i--) {
                    ...
                    bossDamage = Math.min(bossDamage * 5, 200000000);
                    bossMaxHealth = Math.min(bossMaxHealth * 5, 2000000000);
                    bosses.add(new NADIC(
                            zone,
                            clan,
                            (int) bossDamage,
                            (int) bossMaxHealth));
                    bossDamage = Math.min(bossDamage * 10, 200000000);
                    bossMaxHealth = Math.min(bossMaxHealth * 10, 2000000000);
