...
public class Pet extends Player {
    ...
    public short getHead() {
        ...
        if (effectSkill != null && effectSkill.isMonkey) {
            ...
            return 553;
        } else if (this.typePet == 5) { // Fide
            return 1476;
        } else if (this.typePet == 6) { // Kid Bư
            return 1482;
        } else if (this.typePet == 7) { // Xên
            return 1479;
        } else if (this.typePet == 8) { // Kid Beerus
            if (!this.isTransform) {
                return 1422;
            }
            return 1422;
        ...
        if (this.playerSkill != null) {
            switch (this.playerSkill.getSizeSkill()) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    // Skill 5, 6, 7 đã bị tắt - chỉ giữ lại 4 skill
                    break;
            }
        }
    }
