        ...
        if (!player.isBoss && !player.isPet) {
            switch (mob.tempId) {
                ...
                case ConstMob.HEO_XAYDA:
                    ...
                    switch (mob.tempId) {
                        case ConstMob.HEO_RUNG:
                            ...
                            doneTask(player, ConstTask.TASK_13_1); // Hoàn thành nhiệm vụ TASK_13_1 (nhiệm vụ kế tiếp)
                            break;
                        case ConstMob.HEO_DA_XANH:
                            doneTask(player, ConstTask.TASK_13_1); // Hoàn thành nhiệm vụ TASK_13_1
                            doneTask(player, ConstTask.TASK_13_2); // Hoàn thành nhiệm vụ TASK_13_2 (nhiệm vụ kế tiếp)
                            break;
                        case ConstMob.HEO_XAYDA:
                            doneTask(player, ConstTask.TASK_13_2); // Hoàn thành nhiệm vụ TASK_13_2
                            doneTask(player, ConstTask.TASK_13_3); // Hoàn thành nhiệm vụ TASK_13_3 (nhiệm vụ kế tiếp)
                            break;
                    }
                ...
                case ConstMob.QUY_MAP:
                    ...
                    switch (mob.tempId) {
                        case ConstMob.BULON:
                            doneTask(player, ConstTask.TASK_15_1); // Hoàn thành nhiệm vụ TASK_15_1
                            doneTask(player, ConstTask.TASK_15_2); // Hoàn thành nhiệm vụ TASK_15_2 (nhiệm vụ kế tiếp)
                            break;
                        case ConstMob.UKULELE:
                            doneTask(player, ConstTask.TASK_15_2); // Hoàn thành nhiệm vụ TASK_15_2
                            doneTask(player, ConstTask.TASK_15_3); // Hoàn thành nhiệm vụ TASK_15_3 (nhiệm vụ kế tiếp)
                            break;
                        case ConstMob.QUY_MAP:
                            doneTask(player, ConstTask.TASK_15_3); // Hoàn thành nhiệm vụ TASK_15_3
                            doneTask(player, ConstTask.TASK_15_4); // Hoàn thành nhiệm vụ TASK_15_4 (nhiệm vụ kế tiếp)
                            break;
                    }
                    break;
